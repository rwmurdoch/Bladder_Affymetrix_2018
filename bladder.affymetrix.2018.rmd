...
will be used to attach gene names and functions to the final diff.exp. tables
```{r}
...
This table can be regarded as a final output.  
...
https://reactome.org/PathwayBrowser/#TOOL=AT is simple though. Pasting in the list of genes, we get access to a pathway map
with a good deal of depth for exploration
